...
$(document).ready(function () {
  ...
  $('.form_submit').on('click', function () {
    ...
    // }
      ...
      fromGo = true
      $.ajax({
        url: 'http://kenzo-ginger.max-digital.cn/sina/index/putFormInfo',
        data: {
          name: $('.name').val(),
          mobile: $('.mobile').val(),
          code: $('.password').val(),
  ...
  $('.codeBtn').on('click', function () {
    ...
    $.ajax({
      url: 'http://kenzo-ginger.max-digital.cn/sina/index/sendsms',
      type: 'post',
      data: {
        mobile: $('.mobile').val(),
      },
...
function baozha(params) {
  ...
  if (ball_click >= 3) {
    $.ajax({
      url: 'http://kenzo-ginger.max-digital.cn/sina/index/getLuckDraw',
      data: {
        token: tokenID
      },
      type: 'post',
